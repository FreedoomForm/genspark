# Urok 146. Товары / История

**Route:** `/products/history`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/products/history

![Screenshot](../shots259/146_products__history.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/products/history` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto stranitsa detalnogo prosmotra v razdele «Товары», gde mozhno izuchit podrobnosti, svyazannye dokumenty ili istoriyu izmeneniy.
