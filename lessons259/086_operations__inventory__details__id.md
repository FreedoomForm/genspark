# Urok 086. Операции / Инвентаризация / Детали / :id

**Route:** `/operations/inventory/details/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/inventory/details/:id

![Screenshot](../shots259/086_operations__inventory__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/inventory/details/:id` i kak s nim rabotat v admin-paneli Lume.
