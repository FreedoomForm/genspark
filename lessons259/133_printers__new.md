# Urok 133. Принтеры / Новый

**Route:** `/printers/new`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/printers/new

![Screenshot](../shots259/133_printers__new.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/printers/new` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Принтеры». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
