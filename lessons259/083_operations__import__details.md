# Urok 083. Операции / Импорт / Детали

**Route:** `/operations/import/details`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/import/details

![Screenshot](../shots259/083_operations__import__details.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/import/details` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto stranitsa detalnogo prosmotra v razdele «Операции», gde mozhno izuchit podrobnosti, svyazannye dokumenty ili istoriyu izmeneniy.
