# Urok 160. Акции / Типы / :type / Товары

**Route:** `/stocks/types/:type/products`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/stocks/types/:type/products

![Screenshot](../shots259/225_stocks__types__type__products.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/stocks/types/:type/products` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Акции». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
