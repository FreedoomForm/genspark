...
**Route:** `/interface`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/interface

![Screenshot](../shots259/061_interface.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/interface` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Интерфейс». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
