# Urok 195. Отчёты / Сальдо

**Route:** `/reports/saldo`  
**Razdel:** Отчёты  
**URL:** https://admin.lume.uz/reports/saldo

![Screenshot](../shots259/195_reports__saldo.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/reports/saldo` i kak s nim rabotat v admin-paneli Lume.
