# Urok 092. Операции / Трансфер

**Route:** `/operations/transfer`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/transfer

![Screenshot](../shots259/092_operations__transfer.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/transfer` i kak s nim rabotat v admin-paneli Lume.
