# Urok 055. Глобальный склад / add

**Route:** `/globalwarehouse/add`  
**Razdel:** Склад  
**URL:** https://admin.lume.uz/globalwarehouse/add

![Screenshot](../shots259/055_globalwarehouse__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/globalwarehouse/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Глобальный склад». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
