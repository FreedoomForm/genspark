# Urok 174. Продавец / add

**Route:** `/vendor/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/vendor/add

![Screenshot](../shots259/241_vendor__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/vendor/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Продавец». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.

Osnovnoy zagolovok ili samyy zametnyy tekst na ekrane: **Продавец / add**.
