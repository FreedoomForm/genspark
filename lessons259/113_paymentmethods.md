# Urok 113. Методы оплаты

**Route:** `/paymentmethods`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/paymentmethods

![Screenshot](../shots259/113_paymentmethods.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/paymentmethods` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Методы оплаты». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
