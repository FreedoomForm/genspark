# Urok 067. Аудит маркировки / Аудит товаров

**Route:** `/markingaudit/waresaudit`  
**Razdel:** Маркировка  
**URL:** https://admin.lume.uz/markingaudit/waresaudit

![Screenshot](../shots259/067_markingaudit__waresaudit.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/markingaudit/waresaudit` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Аудит маркировки». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
