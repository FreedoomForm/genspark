# Urok 110. Параметры / Инфо / :id

**Route:** `/parameters/info/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/parameters/info/:id

![Screenshot](../shots259/110_parameters__info__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/parameters/info/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Параметры». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
