# Urok 018. Клиенты / Детали / :id

**Route:** `/clients/details/:id`  
**Razdel:** Клиенты  
**URL:** https://admin.lume.uz/clients/details/:id

![Screenshot](../shots259/018_clients__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/clients/details/:id` i kak s nim rabotat v admin-paneli Lume.
