...
**Route:** `/reports/pl`  
**Razdel:** Отчёты  
**URL:** https://admin.lume.uz/reports/pl

![Screenshot](../shots259/194_reports__pl.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/reports/pl` i kak s nim rabotat v admin-paneli Lume.
