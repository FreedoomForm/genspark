# Urok 045. Финансы / Редактирование / :id

**Route:** `/finance/edit/:id`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/edit/:id

![Screenshot](../shots259/045_finance__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/edit/:id` i kak s nim rabotat v admin-paneli Lume.
