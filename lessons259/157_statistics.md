...
**Route:** `/statistics`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/statistics

![Screenshot](../shots259/222_statistics.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/statistics` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Статистика». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
