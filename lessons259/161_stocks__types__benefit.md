# Urok 161. Акции / Типы / Бонус

**Route:** `/stocks/types/benefit`  
**Razdel:** Акции  
**URL:** https://admin.lume.uz/stocks/types/benefit

![Screenshot](../shots259/226_stocks__types__benefit.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/stocks/types/benefit` i kak s nim rabotat v admin-paneli Lume.
