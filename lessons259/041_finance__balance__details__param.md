# Urok 041. Финансы / Баланс / Детали / :param

**Route:** `/finance/balance/details/:param`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/balance/details/:param

![Screenshot](../shots259/041_finance__balance__details__param.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/balance/details/:param` i kak s nim rabotat v admin-paneli Lume.
