# Urok 117. Права доступа / Редактирование / :id

**Route:** `/permissions/edit/:id`  
**Razdel:** Настройки  
**URL:** https://admin.lume.uz/permissions/edit/:id

![Screenshot](../shots259/117_permissions__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/permissions/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Права доступа». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
