# Urok 152. Товары / Списание / Редактирование / :id

**Route:** `/products/writeoff/edit/:id`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/products/writeoff/edit/:id

![Screenshot](../shots259/152_products__writeoff__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/products/writeoff/edit/:id` i kak s nim rabotat v admin-paneli Lume.
