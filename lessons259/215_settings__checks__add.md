# Urok 215. Настройки / Чеки / add

**Route:** `/settings/checks/add`  
**Razdel:** Настройки  
**URL:** https://admin.lume.uz/settings/checks/add

![Screenshot](../shots259/215_settings__checks__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/settings/checks/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Настройки». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
