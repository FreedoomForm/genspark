# Urok 181. Реализации / Редактирование / :id

**Route:** `/realizations/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/realizations/edit/:id

![Screenshot](../shots259/181_realizations__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/realizations/edit/:id` i kak s nim rabotat v admin-paneli Lume.
