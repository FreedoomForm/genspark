# Urok 090. Операции / Переоценка / Детали / :id

**Route:** `/operations/overvaluation/details/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/overvaluation/details/:id

![Screenshot](../shots259/090_operations__overvaluation__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/overvaluation/details/:id` i kak s nim rabotat v admin-paneli Lume.
