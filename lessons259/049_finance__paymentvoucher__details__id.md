# Urok 049. Финансы / Платежная ведомость / Детали / :id

**Route:** `/finance/paymentvoucher/details/:id`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/paymentvoucher/details/:id

![Screenshot](../shots259/049_finance__paymentvoucher__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/paymentvoucher/details/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Финансы». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
