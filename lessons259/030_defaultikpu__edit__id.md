# Urok 030. ИКПУ / Редактирование / :id

**Route:** `/defaultikpu/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/defaultikpu/edit/:id

![Screenshot](../shots259/030_defaultikpu__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/defaultikpu/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «ИКПУ». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
