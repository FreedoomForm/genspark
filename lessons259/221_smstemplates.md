# Urok 221. SMS шаблоны

**Route:** `/smstemplates`  
**Razdel:** Маркетинг  
**URL:** https://admin.lume.uz/smstemplates

![Screenshot](../shots259/221_smstemplates.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/smstemplates` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «SMS шаблоны». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
