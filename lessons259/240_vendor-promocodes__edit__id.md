# Urok 240. Промокоды продавца / Редактирование / :id

**Route:** `/vendor-promocodes/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/vendor-promocodes/edit/:id

![Screenshot](../shots259/240_vendor-promocodes__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/vendor-promocodes/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Промокоды продавца». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
