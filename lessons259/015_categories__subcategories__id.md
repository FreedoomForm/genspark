# Urok 015. Категории / Подкатегории / :id

**Route:** `/categories/subcategories/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/categories/subcategories/:id

![Screenshot](../shots259/015_categories__subcategories__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/categories/subcategories/:id` i kak s nim rabotat v admin-paneli Lume.
