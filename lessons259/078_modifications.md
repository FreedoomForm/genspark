# Urok 078. Модификации

**Route:** `/modifications`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/modifications

![Screenshot](../shots259/078_modifications.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/modifications` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Модификации». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
