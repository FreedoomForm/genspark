# Urok 143. Роли / Редактирование

**Route:** `/roles/edit`  
**Razdel:** Настройки  
**URL:** https://admin.lume.uz/roles/edit

![Screenshot](../shots259/204_roles__edit.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/roles/edit` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto stranitsa redaktirovaniya v razdele «Роли». Zdes obyčno menyayut sushchestvuyushchie dannye i sohranyayut izmeneniya.
