# Urok 117. Поставщики / Заявки

**Route:** `/providers/requests`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/requests

![Screenshot](../shots259/175_providers__requests.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/requests` i kak s nim rabotat v admin-paneli Lume.
