# Urok 064. Лицензии / connect

**Route:** `/licenses/connect`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/licenses/connect

![Screenshot](../shots259/064_licenses__connect.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/licenses/connect` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Лицензии». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
