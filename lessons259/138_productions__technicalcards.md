# Urok 138. Производство / Техкарты

**Route:** `/productions/technicalcards`  
**Razdel:** Производство  
**URL:** https://admin.lume.uz/productions/technicalcards

![Screenshot](../shots259/138_productions__technicalcards.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/productions/technicalcards` i kak s nim rabotat v admin-paneli Lume.
