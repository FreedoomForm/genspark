# Urok 256. Сотрудники / Инфо / shift / income / :id

**Route:** `/workers/info/shift/income/:id`  
**Razdel:** Сотрудники  
**URL:** https://admin.lume.uz/workers/info/shift/income/:id

![Screenshot](../shots259/256_workers__info__shift__income__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/workers/info/shift/income/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Сотрудники». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
