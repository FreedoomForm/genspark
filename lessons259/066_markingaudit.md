# Urok 066. Аудит маркировки

**Route:** `/markingaudit`  
**Razdel:** Маркировка  
**URL:** https://admin.lume.uz/markingaudit

![Screenshot](../shots259/066_markingaudit.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/markingaudit` i kak s nim rabotat v admin-paneli Lume.
