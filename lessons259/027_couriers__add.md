# Urok 027. Курьеры / add

**Route:** `/couriers/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/couriers/add

![Screenshot](../shots259/027_couriers__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/couriers/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Курьеры». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
