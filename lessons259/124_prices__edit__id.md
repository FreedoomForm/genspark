# Urok 124. Цены / Редактирование / :id

**Route:** `/prices/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/prices/edit/:id

![Screenshot](../shots259/124_prices__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/prices/edit/:id` i kak s nim rabotat v admin-paneli Lume.
