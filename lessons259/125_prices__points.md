...
**Route:** `/prices/points`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/prices/points

![Screenshot](../shots259/125_prices__points.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/prices/points` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Цены». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
