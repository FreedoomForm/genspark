# Urok 005. Штрихкоды / Создание

**Route:** `/barcodes/create`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/barcodes/create

![Screenshot](../shots259/005_barcodes__create.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/barcodes/create` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Штрихкоды». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
