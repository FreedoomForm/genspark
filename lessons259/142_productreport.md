# Urok 142. Товарный отчёт

**Route:** `/productreport`  
**Razdel:** Отчёты  
**URL:** https://admin.lume.uz/productreport

![Screenshot](../shots259/142_productreport.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/productreport` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Товарный отчёт». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
