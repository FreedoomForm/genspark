# Urok 043. Финансы / Создание / Расход

**Route:** `/finance/create/expense`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/create/expense

![Screenshot](../shots259/043_finance__create__expense.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/create/expense` i kak s nim rabotat v admin-paneli Lume.
