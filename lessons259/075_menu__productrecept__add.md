# Urok 075. Меню / Рецепт товара / add

**Route:** `/menu/productrecept/add`  
**Razdel:** Меню  
**URL:** https://admin.lume.uz/menu/productrecept/add

![Screenshot](../shots259/075_menu__productrecept__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/menu/productrecept/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Меню». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
