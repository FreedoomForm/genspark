# Urok 242. Продавец / Редактирование / :id

**Route:** `/vendor/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/vendor/edit/:id

![Screenshot](../shots259/242_vendor__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/vendor/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Продавец». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.

Osnovnoy zagolovok ili samyy zametnyy tekst na ekrane: **Продавец / Редактирование / :id**.
