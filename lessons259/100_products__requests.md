# Urok 100. Товары / Заявки

**Route:** `/products/requests`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/products/requests

![Screenshot](../shots259/147_products__requests.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/products/requests` i kak s nim rabotat v admin-paneli Lume.
