# Urok 053. Финансы / Транзакции / Создание / :id

**Route:** `/finance/transactions/create/:id`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/transactions/create/:id

![Screenshot](../shots259/053_finance__transactions__create__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/transactions/create/:id` i kak s nim rabotat v admin-paneli Lume.
