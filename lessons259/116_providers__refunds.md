# Urok 116. Поставщики / refunds

**Route:** `/providers/refunds`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/refunds

![Screenshot](../shots259/172_providers__refunds.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/refunds` i kak s nim rabotat v admin-paneli Lume.
