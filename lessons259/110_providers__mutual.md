# Urok 110. Поставщики / Взаиморасчёты

**Route:** `/providers/mutual`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/mutual

![Screenshot](../shots259/164_providers__mutual.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/mutual` i kak s nim rabotat v admin-paneli Lume.
