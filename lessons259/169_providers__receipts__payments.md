# Urok 169. Поставщики / Поступления / Платежи

**Route:** `/providers/receipts/payments`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/receipts/payments

![Screenshot](../shots259/169_providers__receipts__payments.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/receipts/payments` i kak s nim rabotat v admin-paneli Lume.
