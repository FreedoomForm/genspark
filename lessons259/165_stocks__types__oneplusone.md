# Urok 165. Акции / Типы / 1+1

**Route:** `/stocks/types/oneplusone`  
**Razdel:** Акции  
**URL:** https://admin.lume.uz/stocks/types/oneplusone

![Screenshot](../shots259/230_stocks__types__oneplusone.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/stocks/types/oneplusone` i kak s nim rabotat v admin-paneli Lume.
