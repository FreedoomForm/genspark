# Urok 111. Поставщики / Взаиморасчёты / Детали / :name

**Route:** `/providers/mutual/details/:name`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/mutual/details/:name

![Screenshot](../shots259/165_providers__mutual__details__name.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/mutual/details/:name` i kak s nim rabotat v admin-paneli Lume.
