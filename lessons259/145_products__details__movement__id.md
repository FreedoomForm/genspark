# Urok 145. Товары / Детали / Движение / :id

**Route:** `/products/details/movement/:id`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/products/details/movement/:id

![Screenshot](../shots259/145_products__details__movement__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/products/details/movement/:id` i kak s nim rabotat v admin-paneli Lume.
