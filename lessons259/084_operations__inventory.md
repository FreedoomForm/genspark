# Urok 084. Операции / Инвентаризация

**Route:** `/operations/inventory`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/inventory

![Screenshot](../shots259/084_operations__inventory.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/inventory` i kak s nim rabotat v admin-paneli Lume.
