# Urok 151. Товары / Списание / Детали / :id

**Route:** `/products/writeoff/details/:id`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/products/writeoff/details/:id

![Screenshot](../shots259/151_products__writeoff__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/products/writeoff/details/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Товары». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
