# Urok 081. Операции / Импорт

**Route:** `/operations/import`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/import

![Screenshot](../shots259/081_operations__import.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/import` i kak s nim rabotat v admin-paneli Lume.
