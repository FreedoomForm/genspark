...
**Route:** `/layout`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/layout

![Screenshot](../shots259/062_layout.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/layout` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Макет». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
