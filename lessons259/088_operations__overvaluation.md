# Urok 088. Операции / Переоценка

**Route:** `/operations/overvaluation`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/overvaluation

![Screenshot](../shots259/088_operations__overvaluation.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/overvaluation` i kak s nim rabotat v admin-paneli Lume.
