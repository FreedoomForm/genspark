# Urok 037. Избранное / add

**Route:** `/favorites/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/favorites/add

![Screenshot](../shots259/037_favorites__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/favorites/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Избранное». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
