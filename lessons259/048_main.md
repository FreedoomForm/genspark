...
**Route:** `/main`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/main

![Screenshot](../shots259/065_main.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/main` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Главная». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
