# Urok 108. Заказы / Самовывоз / :id

**Route:** `/orders/takeaway/:id`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/takeaway/:id

![Screenshot](../shots259/108_orders__takeaway__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/takeaway/:id` i kak s nim rabotat v admin-paneli Lume.
