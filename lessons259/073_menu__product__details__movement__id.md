# Urok 073. Меню / Товар / Детали / Движение / :id

**Route:** `/menu/product/details/movement/:id`  
**Razdel:** Меню  
**URL:** https://admin.lume.uz/menu/product/details/movement/:id

![Screenshot](../shots259/073_menu__product__details__movement__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/menu/product/details/movement/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Меню». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
