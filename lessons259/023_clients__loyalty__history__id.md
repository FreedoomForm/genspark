# Urok 023. Клиенты / Лояльность / История / :id

**Route:** `/clients/loyalty/history/:id`  
**Razdel:** Клиенты  
**URL:** https://admin.lume.uz/clients/loyalty/history/:id

![Screenshot](../shots259/023_clients__loyalty__history__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/clients/loyalty/history/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Клиенты». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
