# Urok 186. Регистрация

**Route:** `/register`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/register

![Screenshot](../shots259/186_register.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/register` i kak s nim rabotat v admin-paneli Lume.
