# Urok 112. Поставщики / Поступления

**Route:** `/providers/receipts/`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/receipts/

![Screenshot](../shots259/166_providers__receipts.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/receipts/` i kak s nim rabotat v admin-paneli Lume.
