# Urok 089. Операции / Переоценка / Создание

**Route:** `/operations/overvaluation/create`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/overvaluation/create

![Screenshot](../shots259/089_operations__overvaluation__create.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/overvaluation/create` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Операции». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
