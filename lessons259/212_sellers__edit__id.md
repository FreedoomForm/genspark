# Urok 212. Продавцы / Редактирование / :id

**Route:** `/sellers/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/sellers/edit/:id

![Screenshot](../shots259/212_sellers__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/sellers/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Продавцы». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
