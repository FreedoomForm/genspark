# Urok 160. Поставщики / Контрагенты / Детали / :id

**Route:** `/providers/conteragents/details/:id`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/conteragents/details/:id

![Screenshot](../shots259/160_providers__conteragents__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/conteragents/details/:id` i kak s nim rabotat v admin-paneli Lume.
