...
**Route:** `/menu`  
**Razdel:** Меню  
**URL:** https://admin.lume.uz/menu

![Screenshot](../shots259/069_menu.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/menu` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Меню». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
