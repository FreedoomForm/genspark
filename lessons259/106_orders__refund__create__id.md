# Urok 106. Заказы / Возврат / Создание / :id

**Route:** `/orders/refund/create/:id`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/refund/create/:id

![Screenshot](../shots259/106_orders__refund__create__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/refund/create/:id` i kak s nim rabotat v admin-paneli Lume.
