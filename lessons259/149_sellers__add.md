# Urok 149. Продавцы / add

**Route:** `/sellers/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/sellers/add

![Screenshot](../shots259/211_sellers__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/sellers/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Продавцы». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
