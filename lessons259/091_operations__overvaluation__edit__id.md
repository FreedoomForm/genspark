# Urok 091. Операции / Переоценка / Редактирование / :id

**Route:** `/operations/overvaluation/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/overvaluation/edit/:id

![Screenshot](../shots259/091_operations__overvaluation__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/overvaluation/edit/:id` i kak s nim rabotat v admin-paneli Lume.
