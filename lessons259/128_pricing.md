# Urok 128. Ценообразование

**Route:** `/pricing`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/pricing

![Screenshot](../shots259/128_pricing.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/pricing` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Ценообразование». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
