# Urok 250. Сотрудники / Детали / История / :id

**Route:** `/workers/details/history/:id`  
**Razdel:** Сотрудники  
**URL:** https://admin.lume.uz/workers/details/history/:id

![Screenshot](../shots259/250_workers__details__history__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/workers/details/history/:id` i kak s nim rabotat v admin-paneli Lume.
