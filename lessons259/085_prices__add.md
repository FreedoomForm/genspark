...
**Route:** `/prices/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/prices/add

![Screenshot](../shots259/123_prices__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/prices/add` i kak s nim rabotat v admin-paneli Lume.
