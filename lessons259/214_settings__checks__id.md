# Urok 214. Настройки / Чеки / :id

**Route:** `/settings/checks/:id`  
**Razdel:** Настройки  
**URL:** https://admin.lume.uz/settings/checks/:id

![Screenshot](../shots259/214_settings__checks__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/settings/checks/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Настройки». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
