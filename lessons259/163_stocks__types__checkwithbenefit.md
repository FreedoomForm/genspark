# Urok 163. Акции / Типы / Чек с бонусом

**Route:** `/stocks/types/checkwithbenefit`  
**Razdel:** Акции  
**URL:** https://admin.lume.uz/stocks/types/checkwithbenefit

![Screenshot](../shots259/228_stocks__types__checkwithbenefit.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/stocks/types/checkwithbenefit` i kak s nim rabotat v admin-paneli Lume.
