...
**Route:** `/defaultikpu/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/defaultikpu/add

![Screenshot](../shots259/029_defaultikpu__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/defaultikpu/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «ИКПУ». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
