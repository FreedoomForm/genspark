# Urok 099. Заказы / Бронирование / :id

**Route:** `/orders/booking/:id`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/booking/:id

![Screenshot](../shots259/099_orders__booking__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/booking/:id` i kak s nim rabotat v admin-paneli Lume.
