# Urok 148. Товары / stats / :id

**Route:** `/products/stats/:id`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/products/stats/:id

![Screenshot](../shots259/148_products__stats__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/products/stats/:id` i kak s nim rabotat v admin-paneli Lume.
