# Urok 059. Информация / add

**Route:** `/information/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/information/add

![Screenshot](../shots259/059_information__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/information/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Информация». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
