# Urok 072. Меню / Товар / Детали / :id

**Route:** `/menu/product/details/:id`  
**Razdel:** Меню  
**URL:** https://admin.lume.uz/menu/product/details/:id

![Screenshot](../shots259/072_menu__product__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/menu/product/details/:id` i kak s nim rabotat v admin-paneli Lume.
