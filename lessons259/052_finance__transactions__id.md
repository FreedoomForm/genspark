# Urok 052. Финансы / Транзакции / :id

**Route:** `/finance/transactions/:id`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/transactions/:id

![Screenshot](../shots259/052_finance__transactions__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/transactions/:id` i kak s nim rabotat v admin-paneli Lume.
