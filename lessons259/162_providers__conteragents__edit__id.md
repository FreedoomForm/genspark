# Urok 162. Поставщики / Контрагенты / Редактирование / :id

**Route:** `/providers/conteragents/edit/:id`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/conteragents/edit/:id

![Screenshot](../shots259/162_providers__conteragents__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/conteragents/edit/:id` i kak s nim rabotat v admin-paneli Lume.
