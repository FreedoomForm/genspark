# Urok 174. Поставщики / refunds / Редактирование / :id

**Route:** `/providers/refunds/edit/:id`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/refunds/edit/:id

![Screenshot](../shots259/174_providers__refunds__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/refunds/edit/:id` i kak s nim rabotat v admin-paneli Lume.
