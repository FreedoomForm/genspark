# Urok 076. Меню / Товары / :id

**Route:** `/menu/products/:id`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/menu/products/:id

![Screenshot](../shots259/076_menu__products__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/menu/products/:id` i kak s nim rabotat v admin-paneli Lume.
