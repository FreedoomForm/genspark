# Urok 253. Сотрудники / Инфо / permission / :id

**Route:** `/workers/info/permission/:id`  
**Razdel:** Сотрудники  
**URL:** https://admin.lume.uz/workers/info/permission/:id

![Screenshot](../shots259/253_workers__info__permission__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/workers/info/permission/:id` i kak s nim rabotat v admin-paneli Lume.
