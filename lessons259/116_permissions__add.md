# Urok 116. Права доступа / add

**Route:** `/permissions/add`  
**Razdel:** Настройки  
**URL:** https://admin.lume.uz/permissions/add

![Screenshot](../shots259/116_permissions__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/permissions/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Права доступа». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
