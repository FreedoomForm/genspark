# Urok 121. Реализация / add

**Route:** `/realization/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/realization/add

![Screenshot](../shots259/179_realization__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/realization/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Реализация». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
