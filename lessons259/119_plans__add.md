...
**Route:** `/plans/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/plans/add

![Screenshot](../shots259/119_plans__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/plans/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Планы». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
