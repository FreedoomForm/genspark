# Urok 180. Реализации / Детали / :id

**Route:** `/realizations/details/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/realizations/details/:id

![Screenshot](../shots259/180_realizations__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/realizations/details/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Реализации». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
