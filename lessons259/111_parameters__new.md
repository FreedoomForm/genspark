# Urok 111. Параметры / Новый

**Route:** `/parameters/new`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/parameters/new

![Screenshot](../shots259/111_parameters__new.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/parameters/new` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Параметры». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
