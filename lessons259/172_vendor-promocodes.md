# Urok 172. Промокоды продавца

**Route:** `/vendor-promocodes`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/vendor-promocodes

![Screenshot](../shots259/238_vendor-promocodes.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/vendor-promocodes` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Промокоды продавца». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
