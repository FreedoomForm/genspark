# Urok 185. refunds / Детали

**Route:** `/refunds/details`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/refunds/details

![Screenshot](../shots259/185_refunds__details.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/refunds/details` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto stranitsa detalnogo prosmotra v razdele «refunds», gde mozhno izuchit podrobnosti, svyazannye dokumenty ili istoriyu izmeneniy.
