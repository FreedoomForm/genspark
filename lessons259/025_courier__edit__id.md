# Urok 025. Курьер / Редактирование / :id

**Route:** `/courier/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/courier/edit/:id

![Screenshot](../shots259/025_courier__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/courier/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Курьер». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
