...
**Route:** `/tags/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/tags/add

![Screenshot](../shots259/233_tags__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/tags/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Теги». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
