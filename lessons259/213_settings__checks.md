# Urok 213. Настройки / Чеки

**Route:** `/settings/checks`  
**Razdel:** Настройки  
**URL:** https://admin.lume.uz/settings/checks

![Screenshot](../shots259/213_settings__checks.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/settings/checks` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Настройки». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
