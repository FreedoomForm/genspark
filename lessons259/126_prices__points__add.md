# Urok 126. Цены / Точки / add

**Route:** `/prices/points/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/prices/points/add

![Screenshot](../shots259/126_prices__points__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/prices/points/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Цены». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
