# Urok 130. Ценообразование / Редактирование / :id

**Route:** `/pricing/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/pricing/edit/:id

![Screenshot](../shots259/130_pricing__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/pricing/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Ценообразование». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
