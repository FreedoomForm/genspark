# Urok 046. Финансы / Расход

**Route:** `/finance/expense`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/expense

![Screenshot](../shots259/046_finance__expense.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/expense` i kak s nim rabotat v admin-paneli Lume.
