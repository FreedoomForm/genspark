# Urok 098. Заказы / Активные

**Route:** `/orders/active`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/active

![Screenshot](../shots259/098_orders__active.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/active` i kak s nim rabotat v admin-paneli Lume.
