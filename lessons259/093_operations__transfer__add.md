# Urok 093. Операции / Трансфер / add

**Route:** `/operations/transfer/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/transfer/add

![Screenshot](../shots259/093_operations__transfer__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/transfer/add` i kak s nim rabotat v admin-paneli Lume.
