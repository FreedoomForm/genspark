# Urok 199. Заявка / Обработка

**Route:** `/request/procces`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/request/procces

![Screenshot](../shots259/199_request__procces.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/request/procces` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Заявка». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
