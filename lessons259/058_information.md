...
**Route:** `/information`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/information

![Screenshot](../shots259/058_information.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/information` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Информация». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
