# Urok 252. Сотрудники / Инфо / Заказы / :id

**Route:** `/workers/info/orders/:id`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/workers/info/orders/:id

![Screenshot](../shots259/252_workers__info__orders__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/workers/info/orders/:id` i kak s nim rabotat v admin-paneli Lume.
