# Urok 035. Водители / Редактирование / :id

**Route:** `/drivers/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/drivers/edit/:id

![Screenshot](../shots259/035_drivers__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/drivers/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Водители». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
