...
**Route:** `/couriers`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/couriers

![Screenshot](../shots259/026_couriers.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/couriers` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Курьеры». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
