# Urok 115. Права доступа

**Route:** `/permissions`  
**Razdel:** Настройки  
**URL:** https://admin.lume.uz/permissions

![Screenshot](../shots259/115_permissions.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/permissions` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Права доступа». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
