# Urok 020. Клиенты / Детали / История / :id

**Route:** `/clients/details/history/:id`  
**Razdel:** Клиенты  
**URL:** https://admin.lume.uz/clients/details/history/:id

![Screenshot](../shots259/020_clients__details__history__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/clients/details/history/:id` i kak s nim rabotat v admin-paneli Lume.
