# Urok 251. Сотрудники / Редактирование / :id

**Route:** `/workers/edit/:id`  
**Razdel:** Сотрудники  
**URL:** https://admin.lume.uz/workers/edit/:id

![Screenshot](../shots259/251_workers__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/workers/edit/:id` i kak s nim rabotat v admin-paneli Lume.
