# Urok 095. Операции / Трансфер / Редактирование / :id

**Route:** `/operations/transfer/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/transfer/edit/:id

![Screenshot](../shots259/095_operations__transfer__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/transfer/edit/:id` i kak s nim rabotat v admin-paneli Lume.
