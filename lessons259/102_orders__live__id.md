# Urok 102. Заказы / live / :id

**Route:** `/orders/live/:id`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/live/:id

![Screenshot](../shots259/102_orders__live__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/live/:id` i kak s nim rabotat v admin-paneli Lume.
