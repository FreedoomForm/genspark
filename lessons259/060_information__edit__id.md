# Urok 060. Информация / Редактирование / :id

**Route:** `/information/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/information/edit/:id

![Screenshot](../shots259/060_information__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/information/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Информация». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
