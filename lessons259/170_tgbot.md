# Urok 170. Telegram бот

**Route:** `/tgbot`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/tgbot

![Screenshot](../shots259/236_tgbot.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/tgbot` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Telegram бот». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
