# Urok 129. Ценообразование / add

**Route:** `/pricing/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/pricing/add

![Screenshot](../shots259/129_pricing__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/pricing/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Ценообразование». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
