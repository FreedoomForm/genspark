# Urok 077. Меню / Товары / add

**Route:** `/menu/products/add`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/menu/products/add

![Screenshot](../shots259/077_menu__products__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/menu/products/add` i kak s nim rabotat v admin-paneli Lume.
