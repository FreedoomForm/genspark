# Urok 056. Глобальный склад / Редактирование / :id

**Route:** `/globalwarehouse/edit/:id`  
**Razdel:** Склад  
**URL:** https://admin.lume.uz/globalwarehouse/edit/:id

![Screenshot](../shots259/056_globalwarehouse__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/globalwarehouse/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Глобальный склад». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
