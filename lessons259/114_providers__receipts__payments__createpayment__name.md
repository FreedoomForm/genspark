# Urok 114. Поставщики / Поступления / Платежи / Создать платеж / :name

**Route:** `/providers/receipts/payments/createpayment/:name`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/receipts/payments/createpayment/:name

![Screenshot](../shots259/170_providers__receipts__payments__createpayment__name.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/receipts/payments/createpayment/:name` i kak s nim rabotat v admin-paneli Lume.
