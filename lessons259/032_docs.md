...
**Route:** `/docs`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/docs

![Screenshot](../shots259/032_docs.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/docs` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Документы». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
