# Urok 134. Товар / История изменений / :id

**Route:** `/product/changelog/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/product/changelog/:id

![Screenshot](../shots259/134_product__changelog__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/product/changelog/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Товар». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
