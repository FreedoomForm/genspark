# Urok 127. Цены / Точки / Редактирование / :id

**Route:** `/prices/points/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/prices/points/edit/:id

![Screenshot](../shots259/127_prices__points__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/prices/points/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Цены». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
