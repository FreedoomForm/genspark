# Urok 101. Заказы / Удалённые

**Route:** `/orders/delited`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/delited

![Screenshot](../shots259/101_orders__delited.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/delited` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Заказы». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
