...
**Route:** `/roles/add`  
**Razdel:** Настройки  
**URL:** https://admin.lume.uz/roles/add

![Screenshot](../shots259/203_roles__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/roles/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Роли». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
