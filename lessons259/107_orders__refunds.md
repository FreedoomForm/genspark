# Urok 107. Заказы / refunds

**Route:** `/orders/refunds`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/refunds

![Screenshot](../shots259/107_orders__refunds.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/refunds` i kak s nim rabotat v admin-paneli Lume.
