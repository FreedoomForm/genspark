...
**Route:** `/ado/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/ado/:id

![Screenshot](../shots259/002_ado__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/ado/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «ЭДО». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
