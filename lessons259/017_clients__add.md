# Urok 017. Клиенты / add

**Route:** `/clients/add`  
**Razdel:** Клиенты  
**URL:** https://admin.lume.uz/clients/add

![Screenshot](../shots259/017_clients__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/clients/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Клиенты». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
