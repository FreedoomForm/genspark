# Urok 132. Принтеры / Редактирование / :id

**Route:** `/printers/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/printers/edit/:id

![Screenshot](../shots259/132_printers__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/printers/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Принтеры». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
