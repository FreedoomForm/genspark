# Urok 168. Поставщики / Поступления / Редактирование / :id

**Route:** `/providers/receipts/edit/:id`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/receipts/edit/:id

![Screenshot](../shots259/168_providers__receipts__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/receipts/edit/:id` i kak s nim rabotat v admin-paneli Lume.
