# Urok 219. SMS рассылка / Редактирование / :id

**Route:** `/smsmailing/edit/:id`  
**Razdel:** Маркетинг  
**URL:** https://admin.lume.uz/smsmailing/edit/:id

![Screenshot](../shots259/219_smsmailing__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/smsmailing/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «SMS рассылка». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
