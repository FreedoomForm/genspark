# Urok 105. Заказы / order / refundlist / :id

**Route:** `/orders/order/refundlist/:id`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/order/refundlist/:id

![Screenshot](../shots259/105_orders__order__refundlist__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/order/refundlist/:id` i kak s nim rabotat v admin-paneli Lume.
