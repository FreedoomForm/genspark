# Urok 074. Меню / Товар / Редактирование / :id

**Route:** `/menu/product/edit/:id`  
**Razdel:** Меню  
**URL:** https://admin.lume.uz/menu/product/edit/:id

![Screenshot](../shots259/074_menu__product__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/menu/product/edit/:id` i kak s nim rabotat v admin-paneli Lume.
