# Urok 009. Кабинет / Подписки

**Route:** `/cabinet/subscriptions`  
**Razdel:** Кабинет  
**URL:** https://admin.lume.uz/cabinet/subscriptions

![Screenshot](../shots259/009_cabinet__subscriptions.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/cabinet/subscriptions` i kak s nim rabotat v admin-paneli Lume.
