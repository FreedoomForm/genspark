# Urok 150. Товары / Списание / add

**Route:** `/products/writeoff/add`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/products/writeoff/add

![Screenshot](../shots259/150_products__writeoff__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/products/writeoff/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Товары». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
