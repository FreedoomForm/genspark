...
**Route:** `/stocks/types`  
**Razdel:** Акции  
**URL:** https://admin.lume.uz/stocks/types

![Screenshot](../shots259/224_stocks__types.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/stocks/types` i kak s nim rabotat v admin-paneli Lume.
