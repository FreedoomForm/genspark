...
**Route:** `/devices`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/devices

![Screenshot](../shots259/031_devices.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/devices` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Устройства». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
