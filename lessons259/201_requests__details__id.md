# Urok 201. Заявки / Детали / :id

**Route:** `/requests/details/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/requests/details/:id

![Screenshot](../shots259/201_requests__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/requests/details/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Заявки». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
