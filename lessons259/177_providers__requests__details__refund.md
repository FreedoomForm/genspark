# Urok 177. Поставщики / Заявки / Детали / Возврат

**Route:** `/providers/requests/details/refund`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/requests/details/refund

![Screenshot](../shots259/177_providers__requests__details__refund.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/requests/details/refund` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto stranitsa detalnogo prosmotra v razdele «Поставщики», gde mozhno izuchit podrobnosti, svyazannye dokumenty ili istoriyu izmeneniy.
