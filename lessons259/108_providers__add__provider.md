# Urok 108. Поставщики / add / Поставщик

**Route:** `/providers/add/provider`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/add/provider

![Screenshot](../shots259/158_providers__add__provider.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/add/provider` i kak s nim rabotat v admin-paneli Lume.
