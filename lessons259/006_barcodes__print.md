# Urok 006. Штрихкоды / Печать

**Route:** `/barcodes/print`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/barcodes/print

![Screenshot](../shots259/006_barcodes__print.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/barcodes/print` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Штрихкоды». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
