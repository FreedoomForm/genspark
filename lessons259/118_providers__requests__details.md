# Urok 118. Поставщики / Заявки / Детали

**Route:** `/providers/requests/details`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/requests/details

![Screenshot](../shots259/176_providers__requests__details.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/requests/details` i kak s nim rabotat v admin-paneli Lume.
