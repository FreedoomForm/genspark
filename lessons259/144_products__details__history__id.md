# Urok 144. Товары / Детали / История / :id

**Route:** `/products/details/history/:id`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/products/details/history/:id

![Screenshot](../shots259/144_products__details__history__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/products/details/history/:id` i kak s nim rabotat v admin-paneli Lume.
