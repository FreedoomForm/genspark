# Urok 012. Категории / add

**Route:** `/categories/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/categories/add

![Screenshot](../shots259/012_categories__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/categories/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Категории». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
