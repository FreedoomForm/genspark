# Urok 159. Поставщики / Контрагенты

**Route:** `/providers/conteragents`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/conteragents

![Screenshot](../shots259/159_providers__conteragents.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/conteragents` i kak s nim rabotat v admin-paneli Lume.
