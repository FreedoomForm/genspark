# Urok 048. Финансы / Платежная ведомость / Создание

**Route:** `/finance/paymentvoucher/create`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/paymentvoucher/create

![Screenshot](../shots259/048_finance__paymentvoucher__create.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/paymentvoucher/create` i kak s nim rabotat v admin-paneli Lume.
