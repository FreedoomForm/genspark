# Urok 255. Сотрудники / Инфо / shift / :id

**Route:** `/workers/info/shift/:id`  
**Razdel:** Сотрудники  
**URL:** https://admin.lume.uz/workers/info/shift/:id

![Screenshot](../shots259/255_workers__info__shift__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/workers/info/shift/:id` i kak s nim rabotat v admin-paneli Lume.
