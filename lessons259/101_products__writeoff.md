# Urok 101. Товары / Списание

**Route:** `/products/writeoff`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/products/writeoff

![Screenshot](../shots259/149_products__writeoff.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/products/writeoff` i kak s nim rabotat v admin-paneli Lume.
