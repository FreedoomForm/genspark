# Urok 013. Категории / Редактирование / :id

**Route:** `/categories/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/categories/edit/:id

![Screenshot](../shots259/013_categories__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/categories/edit/:id` i kak s nim rabotat v admin-paneli Lume.
