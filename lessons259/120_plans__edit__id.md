# Urok 120. Планы / Редактирование / :id

**Route:** `/plans/edit/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/plans/edit/:id

![Screenshot](../shots259/120_plans__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/plans/edit/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Планы». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
