# Urok 103. Заказы / Онлайн / :id

**Route:** `/orders/online/:id`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/online/:id

![Screenshot](../shots259/103_orders__online__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/online/:id` i kak s nim rabotat v admin-paneli Lume.
