# Urok 050. Финансы / Приход

**Route:** `/finance/receipt`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/receipt

![Screenshot](../shots259/050_finance__receipt.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/receipt` i kak s nim rabotat v admin-paneli Lume.
