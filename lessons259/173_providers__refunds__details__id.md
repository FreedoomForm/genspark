# Urok 173. Поставщики / refunds / Детали / :id

**Route:** `/providers/refunds/details/:id`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/refunds/details/:id

![Screenshot](../shots259/173_providers__refunds__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/refunds/details/:id` i kak s nim rabotat v admin-paneli Lume.
