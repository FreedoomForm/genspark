...
**Route:** `/providers`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers

![Screenshot](../shots259/156_providers.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers` i kak s nim rabotat v admin-paneli Lume.
