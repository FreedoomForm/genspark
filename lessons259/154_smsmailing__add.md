# Urok 154. SMS рассылка / add

**Route:** `/smsmailing/add`  
**Razdel:** Маркетинг  
**URL:** https://admin.lume.uz/smsmailing/add

![Screenshot](../shots259/218_smsmailing__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/smsmailing/add` i kak s nim rabotat v admin-paneli Lume.
