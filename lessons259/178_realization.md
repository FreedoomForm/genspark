...
**Route:** `/realization`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/realization

![Screenshot](../shots259/178_realization.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/realization` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Реализация». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
