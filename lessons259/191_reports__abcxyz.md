# Urok 191. Отчёты / abcxyz

**Route:** `/reports/abcxyz`  
**Razdel:** Отчёты  
**URL:** https://admin.lume.uz/reports/abcxyz

![Screenshot](../shots259/191_reports__abcxyz.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/reports/abcxyz` i kak s nim rabotat v admin-paneli Lume.
