# Urok 161. Поставщики / Контрагенты / Детали / Товары / :id

**Route:** `/providers/conteragents/details/products/:id`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/providers/conteragents/details/products/:id

![Screenshot](../shots259/161_providers__conteragents__details__products__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/conteragents/details/products/:id` i kak s nim rabotat v admin-paneli Lume.
