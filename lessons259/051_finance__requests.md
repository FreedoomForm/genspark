# Urok 051. Финансы / Заявки

**Route:** `/finance/requests`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/requests

![Screenshot](../shots259/051_finance__requests.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/requests` i kak s nim rabotat v admin-paneli Lume.
