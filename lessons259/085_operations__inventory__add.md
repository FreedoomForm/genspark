# Urok 085. Операции / Инвентаризация / add

**Route:** `/operations/inventory/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/inventory/add

![Screenshot](../shots259/085_operations__inventory__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/inventory/add` i kak s nim rabotat v admin-paneli Lume.
