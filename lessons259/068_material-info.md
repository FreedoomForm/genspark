# Urok 068. Материальная информация

**Route:** `/material-info`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/material-info

![Screenshot](../shots259/068_material-info.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/material-info` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Материальная информация». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
