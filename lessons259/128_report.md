...
**Route:** `/report`  
**Razdel:** Отчёты  
**URL:** https://admin.lume.uz/report

![Screenshot](../shots259/188_report.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/report` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Отчёт». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
