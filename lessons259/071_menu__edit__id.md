# Urok 071. Меню / Редактирование / :id

**Route:** `/menu/edit/:id`  
**Razdel:** Меню  
**URL:** https://admin.lume.uz/menu/edit/:id

![Screenshot](../shots259/071_menu__edit__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/menu/edit/:id` i kak s nim rabotat v admin-paneli Lume.
