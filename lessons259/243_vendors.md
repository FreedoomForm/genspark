# Urok 243. Продавцы/вендоры

**Route:** `/vendors`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/vendors

![Screenshot](../shots259/243_vendors.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/vendors` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Продавцы/вендоры». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
