# Urok 104. Заказы / order / Возврат / Детали / :id

**Route:** `/orders/order/refund/details/:id`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/order/refund/details/:id

![Screenshot](../shots259/104_orders__order__refund__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/order/refund/details/:id` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto parametricheskiy route razdela «Заказы». Takie stranitsy obychno otkryvayut detalnuyu kartochku, redaktirovanie ili prosmotr konkretnogo obyekta po parametru v adrese.
