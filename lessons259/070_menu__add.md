...
**Route:** `/menu/add`  
**Razdel:** Меню  
**URL:** https://admin.lume.uz/menu/add

![Screenshot](../shots259/070_menu__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/menu/add` i kak s nim rabotat v admin-paneli Lume.
