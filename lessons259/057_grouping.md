# Urok 057. Группировка

**Route:** `/grouping`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/grouping

![Screenshot](../shots259/057_grouping.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/grouping` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Группировка». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
