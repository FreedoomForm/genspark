# Urok 163. Поставщики / Редактирование / Поставщик / :id

**Route:** `/providers/edit/provider/:id`  
**Razdel:** Поставщики  
**URL:** https://admin.lume.uz/providers/edit/provider/:id

![Screenshot](../shots259/163_providers__edit__provider__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/providers/edit/provider/:id` i kak s nim rabotat v admin-paneli Lume.
