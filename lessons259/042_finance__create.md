# Urok 042. Финансы / Создание

**Route:** `/finance/create`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/create

![Screenshot](../shots259/042_finance__create.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/create` i kak s nim rabotat v admin-paneli Lume.
