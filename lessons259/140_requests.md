...
**Route:** `/requests`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/requests

![Screenshot](../shots259/200_requests.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/requests` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Заявки». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
