# Urok 146. Торговые точки

**Route:** `/salepoints`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/salepoints

![Screenshot](../shots259/208_salepoints.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/salepoints` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Торговые точки». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
