# Urok 094. Операции / Трансфер / Детали / :id

**Route:** `/operations/transfer/details/:id`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/transfer/details/:id

![Screenshot](../shots259/094_operations__transfer__details__id.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/transfer/details/:id` i kak s nim rabotat v admin-paneli Lume.
