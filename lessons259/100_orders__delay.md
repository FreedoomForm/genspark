# Urok 100. Заказы / Отложенные

**Route:** `/orders/delay`  
**Razdel:** Заказы  
**URL:** https://admin.lume.uz/orders/delay

![Screenshot](../shots259/100_orders__delay.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/orders/delay` i kak s nim rabotat v admin-paneli Lume.
