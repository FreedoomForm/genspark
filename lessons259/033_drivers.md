...
**Route:** `/drivers`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/drivers

![Screenshot](../shots259/033_drivers.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/drivers` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Водители». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
