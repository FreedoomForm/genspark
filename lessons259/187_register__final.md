# Urok 187. Регистрация / Завершение

**Route:** `/register/final`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/register/final

![Screenshot](../shots259/187_register__final.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/register/final` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Регистрация». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
