# Urok 229. Акции / Типы / Фиксированная цена

**Route:** `/stocks/types/fixprice`  
**Razdel:** Акции  
**URL:** https://admin.lume.uz/stocks/types/fixprice

![Screenshot](../shots259/229_stocks__types__fixprice.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/stocks/types/fixprice` i kak s nim rabotat v admin-paneli Lume.
