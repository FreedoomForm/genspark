# Urok 132. Отчёты / Экспорт товаров

**Route:** `/reports/export-products`  
**Razdel:** Товары  
**URL:** https://admin.lume.uz/reports/export-products

![Screenshot](../shots259/192_reports__export-products.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/reports/export-products` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Отчёты». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
