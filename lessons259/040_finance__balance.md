# Urok 040. Финансы / Баланс

**Route:** `/finance/balance`  
**Razdel:** Финансы  
**URL:** https://admin.lume.uz/finance/balance

![Screenshot](../shots259/040_finance__balance.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/finance/balance` i kak s nim rabotat v admin-paneli Lume.
