...
**Route:** `/defaultikpu`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/defaultikpu

![Screenshot](../shots259/028_defaultikpu.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/defaultikpu` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «ИКПУ». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
