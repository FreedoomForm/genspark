# Urok 147. Торговые точки / add

**Route:** `/salepoints/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/salepoints/add

![Screenshot](../shots259/209_salepoints__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/salepoints/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Торговые точки». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
