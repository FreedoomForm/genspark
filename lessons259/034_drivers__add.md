# Urok 034. Водители / add

**Route:** `/drivers/add`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/drivers/add

![Screenshot](../shots259/034_drivers__add.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/drivers/add` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto forma sozdaniya v razdele «Водители». Na takih stranitsah obyčno zapolnyayut polya, dobavlyayut dannye i sohranyayut novuyu zapis.
