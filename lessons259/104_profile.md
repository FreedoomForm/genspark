...
**Route:** `/profile`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/profile

![Screenshot](../shots259/154_profile.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/profile` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Профиль». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
