# Urok 082. Операции / Импорт / Проверка

**Route:** `/operations/import/check`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/operations/import/check

![Screenshot](../shots259/082_operations__import__check.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/operations/import/check` i kak s nim rabotat v admin-paneli Lume.
