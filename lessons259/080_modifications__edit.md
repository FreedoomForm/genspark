# Urok 080. Модификации / Редактирование

**Route:** `/modifications/edit`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/modifications/edit

![Screenshot](../shots259/080_modifications__edit.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/modifications/edit` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto stranitsa redaktirovaniya v razdele «Модификации». Zdes obyčno menyayut sushchestvuyushchie dannye i sohranyayut izmeneniya.
