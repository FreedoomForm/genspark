...
**Route:** `/salary`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/salary

![Screenshot](../shots259/205_salary.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/salary` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Зарплата». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
