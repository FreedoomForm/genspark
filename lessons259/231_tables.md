...
**Route:** `/tables`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/tables

![Screenshot](../shots259/231_tables.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/tables` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Столы». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
