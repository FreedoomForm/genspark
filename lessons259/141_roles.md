...
**Route:** `/roles`  
**Razdel:** Настройки  
**URL:** https://admin.lume.uz/roles

![Screenshot](../shots259/202_roles.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/roles` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Роли». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
