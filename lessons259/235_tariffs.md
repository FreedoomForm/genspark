...
**Route:** `/tariffs`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/tariffs

![Screenshot](../shots259/235_tariffs.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/tariffs` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Тарифы». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
