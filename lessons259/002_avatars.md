...
**Route:** `/avatars`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/avatars

![Screenshot](../shots259/003_avatars.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/avatars` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Аватары». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
