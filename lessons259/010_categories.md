...
**Route:** `/categories`  
**Razdel:** Общее  
**URL:** https://admin.lume.uz/categories

![Screenshot](../shots259/011_categories.png)

## Tsel uroka
Razobrat, dlya chego nuzhen route `/categories` i kak s nim rabotat v admin-paneli Lume.

## Chto eto za stranitsa
Eto osnovnaya rabochaya stranitsa razdela «Категории». Ona ispolzuetsya dlya poiska, fil'trov, prosmotra tablits i perehoda k svyazannym deystviyam.
